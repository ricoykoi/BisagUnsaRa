...
const validatePassword = (password) => {
  return {
    ...
    noLeadingTrailingSpaces: password === password.trim() && password.length > 0,
  };
};
...
const Register = () => {
  ...
  const isFormValid = username && email && isPasswordValid(password) && passwordsMatch
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          {(showPasswordRequirements || password.length > 0) && (
            ...
            >
              <h4 className="text-sm font-bold mb-3" style={{ color: COLORS.darkBrown }}>
        ...
        <div className="mt-8 p-4 rounded-lg bg-white bg-opacity-50 border border-white border-opacity-30">
          <h4 className="font-bold text-center mb-2 text-sm" style={{ color: COLORS.darkBrown }}>
            Demo Information
          </h4>
          <p className="text-xs text-center" style={{ color: COLORS.grayBrown }}>
